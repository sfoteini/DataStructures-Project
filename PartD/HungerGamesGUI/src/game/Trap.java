...
public class Trap {
	...
	public String loadImgSrc() {
		if(type == "animal")
			return "/resources/TrapAnimal.png";
		else 
			return "/resources/TrapRope.png";
	}
	...
	/**
	 * The setImgSrc() method set the source of the icon of the trap.
	...
	/**
	 * The getImgSrc() method returns the source of the icon of the trap.
