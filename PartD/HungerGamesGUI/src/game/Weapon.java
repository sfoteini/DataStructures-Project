...
public class Weapon {
	...
	public String loadImgSrc() {
		if(type == "pistol")
			return "/resources/Pistol.png";
		else if(type == "bow")
			return "/resources/Bow.png";
		else
			return "/resources/Sword.png";
	}
	...
	/**
	 * The setImgSrc() method set the source of the icon of the weapon.
	...
	/**
	 * The getImgSrc() method returns the source of the icon of the weapon.
