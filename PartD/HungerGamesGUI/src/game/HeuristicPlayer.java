...
public class HeuristicPlayer extends Player {
	...
	HeuristicPlayer(int id, String name, Board board, int score, int x, int y){
		...
		imgSrc = loadImgSrc(); 					// Change image source
	}
	...
	public String loadImgSrc() {
		if(id == 1)
			return "/resources/HeuristicPlayer1.png";
		else 
			return "/resources/HeuristicPlayer2.png";
	}
	...
	@Override
	/**
	 * The statistics() method returns information about the player's move (number of selected move,
	...
	public String statistics() {
		...
		String a = "Player " + id + " chose the move with number " + status[0] +
